      ...
      {data?.map((cauhoi, index) => (
        ...
        >
          ...
          <div className="space-y-2 mt-4">
            <div
              className={
                "space-x-[5px] w-[100%] p-4 border rounded-lg flex hover:bg-accent cursor-pointer " +
                  (value[index + 1] == "A"
                  ? "border-black"
                  : "border-input")
              }
            ...
            >
              <div className="font-bold">C. &nbsp;</div> {tSTL(cauhoi.cautraloiC)}
            </div>
            <div 
                className={
                "space-x-[5px] w-[100%] p-4 border rounded-lg flex hover:bg-accent cursor-pointer " +
            ...
            >
              <div className="font-bold">D. &nbsp;</div> {tSTL(cauhoi.cautraloiD)}
            </div>
          </div>
        </div>
      ))}
